...
public class Main extends JFrame implements MouseListener
{
    ...
    private void cleandestinations(List<Cell> destlist)      //Function to clear the last move's destinations
    {
  ...
  //Function to check if the king will be in danger if the given move is made
    ...
    private ArrayList<Cell> filterdestination (List<Cell> destlist, Cell fromcell)
    {
    ...
    private List<Cell> incheckfilter (List<Cell> destlist, Cell fromcell, int color)
    {
